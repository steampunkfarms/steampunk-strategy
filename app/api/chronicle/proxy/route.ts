// Chronicle proxy — verifies NextAuth session, forwards to Postmaster
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const res = await fetch(`${POSTMASTER_URL}/api/chronicle`, {
      method: 'POST',
      headers: {
    ...
    console.error('Chronicle proxy error:', error)
